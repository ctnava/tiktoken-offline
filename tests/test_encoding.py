...
def test_encode_bytes():
    enc = tiktoken.get_encoding("cl100k_base")
    # assert enc._encode_bytes(b" \xec\x8b\xa4\xed") == [30027, 97] # Current Output
    assert enc._encode_bytes(b" \xec\x8b\xa4\xed") == [62085] #  Unavoidable error due to rust/ python differences
