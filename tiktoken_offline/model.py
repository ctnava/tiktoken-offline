...
def list_model_names() -> list[str]:
    """Returns a list of all model names supported by tiktoken_offline."""
...
def encoding_name_for_model(model_name: str) -> str:
    ...
    if encoding_name is None:
        raise KeyError(
            f"Could not automatically map {model_name} to a tokenizer. "
            "Please use `tiktoken_offline.get_encoding` to explicitly get the tokenizer you expect."
        ) from None
